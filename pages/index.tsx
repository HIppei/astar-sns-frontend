    ...
    <div className="flex justify-center items-center bg-gray-200 w-screen h-screen relative">
      ...
      <main className="items-center h-screen w-1/3 justify-start flex bg-[#0090CD] flex-col">
        ...
        <div className="flex-row flex items-center mb-11 mt-7">
          <Image className="z-10 w-24 h-24" src="/unchain_logo.png" alt="unchain_logo" width={30} height={30} />
          <Image className="w-10 h-7" src="/cross_mark_2_logo-removebg.png" alt="cross_logo" width={30} height={30} />
          <Image className="z-10 w-24 h-24" src="/Astar_logo.png" alt="astar_logo" width={30} height={30} />
        </div>
